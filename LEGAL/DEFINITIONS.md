...
**Adoption**  
The process of applying RCF protection to a project.

**Attribution**  
The requirement to credit the Author when referencing Protected Work.

**Automated Extraction**  
Any use of software, scripts, AI/ML systems, or automated means to analyze, 
process, extract, or replicate elements of Protected Work. Includes but not 
limited to: web scraping, API harvesting, static analysis, dynamic analysis, 
machine learning training data generation.

**Authorization**  
Express written permission from the Author for otherwise prohibited activities.
...
including: SaaS offerings, consulting services, paid integrations, commercial 
products, or monetized content.

**Compliance**  
Adherence to all terms and conditions of the RCF License.

**Correlation Methodology**  
The specific techniques, algorithms, patterns, or logic used to analyze, 
correlate, or derive insights from data. A core protected element under RCF.
...
**Derivative Work**  
A work based upon Protected Work, including modifications, translations, 
abridgments, or any form in which Protected Work may be recast or adapted.
...
automated processing of forked content.
...
**Marker**  
Annotation (e.g., `[RCF:PROTECTED]`) indicating protection level of code 
sections.

**Methodology**  
Systematic approach to solving problems or analyzing data. Core IP protected 
by RCF.
...
**NOTICE**  
Required legal document accompanying Protected Work, summarizing restrictions.

## P

**Protected Work**  
Any software, documentation, methodology, or intellectual property bearing RCF 
notices or markers and governed by RCF-PL.

## R

**RCF (Restricted Correlation Framework)**  
The licensing protocol and protection framework defined in this specification.
...
Ethical reporting of security vulnerabilities to the Author before public 
disclosure.
