...
This project (**{project_name}**) is protected under the **Restricted Correlation Framework Protocol License (RCF-PL) v1.2.4**.
...
"""
    ...
    if os.path.exists(notice_path):
        ...
        print("✅ Generated NOTICE.md with RCF-PL v1.2.4 protections.")
