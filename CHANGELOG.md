...
### Added
- **TypeScript SDK Parity**: Achieve 100% feature parity with Python v2.0.3.
...
- **Scanner Logic**: Updated CLI scanner to recognize the `v2.0.3` protection header.
...
- **SDK Parity**: Synchronized v2.0.3 across NPM and PyPI ecosystems.
