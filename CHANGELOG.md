...
### Added
- **TypeScript SDK Parity**: Achieve 100% feature parity with Python v2.0.1.
...
### Changed
- **Version Synchronization**: Synchronized version `2.0.1` across all documentation, legal assets, and SDKs (NPM & PyPI).
- **Legal Assets**: Renamed `RCF-PL-2.0.1.md` to `RCF-PL-2.0.1.md` and updated internal notices.
- **Scanner Logic**: Updated CLI scanner to recognize the `v2.0.1` protection header.
...
- **SDK Parity**: Synchronized v2.0.1 across NPM and PyPI ecosystems.
