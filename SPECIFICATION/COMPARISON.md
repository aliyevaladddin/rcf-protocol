...
## RCF-PL vs Traditional Open-Source Licenses

> Part of the [RCF Whitepaper](../WHITE_PAPER.md)  
...
This matrix compares RCF-PL against the four most common software licenses across criteria that matter specifically in the context of AI/LLM-era intellectual property protection.

**Licenses compared:**

| Identifier | Full Name | Type |
|---|---|---|
| **RCF-PL** | Restricted Correlation Framework Protocol License | Proprietary/Visible Source |
| **MIT** | MIT License | Permissive Open Source |
| **GPL v3** | GNU General Public License v3 | Copyleft Open Source |
| **Apache 2.0** | Apache License 2.0.6 | Permissive Open Source |
...
| Criterion | RCF-PL | MIT | GPL v3 | Apache 2.0 | BSL 1.1 |
|---|:---:|:---:|:---:|:---:|:---:|
...
**The AI Scraping Gap:** MIT, GPL, and Apache 2.0 contain no provisions addressing automated extraction of logic by AI systems. BSL restricts commercial *use* but does not specifically address AI training as a separate act.
...
Apache 2.0 ░░░░░░░░░░░░░░░░░░░░  No protection whatsoever.
...
| **Unique methodology, protect from AI extraction** | **RCF-PL** |
| **Independent researcher, small lab** | **RCF-PL** |
| **OSINT tooling, proprietary algorithms** | **RCF-PL** |
...
*© 2025 Aladdin Aliyev · Sovereign Code Initiative · Protected under RCF-PL*
